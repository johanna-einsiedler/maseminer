...
You are reading **MASEMiner version `v1.0.0`**.  The same string lives in the `VERSION` file at the repo root — cite that exact string for reproducibility.

```
Einsiedler, J. (2026). MASEMiner (version v1.0.0) [Computer software].
